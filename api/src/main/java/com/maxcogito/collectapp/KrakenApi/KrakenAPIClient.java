...
import com.maxcogito.collectapp.KrakenApi.input.InfoInput;
import com.maxcogito.collectapp.KrakenApi.input.Interval;
import com.maxcogito.collectapp.KrakenApi.result.AccountBalanceResult;
import com.maxcogito.collectapp.KrakenApi.result.AssetPairsResult;
import com.maxcogito.collectapp.KrakenApi.result.AssetsInformationResult;
import com.maxcogito.collectapp.KrakenApi.result.ClosedOrdersResult;
import com.maxcogito.collectapp.KrakenApi.result.LedgersInformationResult;
import com.maxcogito.collectapp.KrakenApi.result.LedgersResult;
import com.maxcogito.collectapp.KrakenApi.result.OHLCResult;
import com.maxcogito.collectapp.KrakenApi.result.OpenOrdersResult;
import com.maxcogito.collectapp.KrakenApi.result.OpenPositionsResult;
import com.maxcogito.collectapp.KrakenApi.result.OrderBookResult;
import com.maxcogito.collectapp.KrakenApi.result.OrdersInformationResult;
...
import com.maxcogito.collectapp.KrakenApi.result.TradeBalanceResult;
import com.maxcogito.collectapp.KrakenApi.result.TradeVolumeResult;
import com.maxcogito.collectapp.KrakenApi.result.TradesHistoryResult;
import com.maxcogito.collectapp.KrakenApi.result.TradesInformationResult;
...
public class KrakenAPIClient {
    ...
    public RecentSpreadResult getRecentSpreads(String pair) throws KrakenApiException {
        ...
        return client.callPublicWithLastId(BASE_URL, KrakenApiMethod.RECENT_SPREADS, RecentSpreadResult.
class, params);
    }
...
;
    ...
    public OrdersInformationResult getOrdersInformation(List<String> transactions) throws KrakenApiException {
        ...
        return client.callPrivate(BASE_URL, KrakenApiMethod.ORDERS_INFORMATION, OrdersInformationResult.
class, params);
    }
    ...
    public TradesInformationResult getTradesInformation(List<String> transactions) throws KrakenApiException {
        ...
        return client.callPrivate(BASE_URL, KrakenApiMethod.TRADES_INFORMATION, TradesInformationResult.
class, params);
    }
    ...
    public TradeVolumeResult getTradeVolume() throws KrakenApiException {
        HttpApiClient<TradeVolumeResult> client = (HttpApiClient<TradeVolumeResult>) this.clientFactory.
getHttpApiClient(apiKey, apiSecret, KrakenApiMethod.TRADE_VOLUME);
